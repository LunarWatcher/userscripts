...
// @downloadURL  https://github.com/LunarWatcher/userscripts/raw/master/MagicEditor/MagicEditorURLMod.user.js
// @updateURL    https://github.com/LunarWatcher/userscripts/raw/master/MagicEditor/MagicEditorURLMod.meta.js
// ==/UserScript==
...
(function() {
    ...
    function extendEditor(root) {
        ...
        App.globals.order = ["omit", "inlineImages", "fixLinks", "edit", "diff", "replace", "output"];
        ...
        App.consts.reasons = {
            ...
            sqlWarnings:   "URL shorteners are disallowed by SE, making your post uneditable - replaced URL(s) with the unshortened variants"
        };
        ...
        App.globals.urlReplacements = {
            // Override: MySQL warnings:
            bitlymysql: {
                expr: /https?:\/\/bit\.ly\/phpmsql/g,
                replacement: "https://stackoverflow.com/q/12859942/",
                reason: App.consts.reasons.sqlWarnings
            },
            offdepr: {
                expr: /https?:\/\/j.mp\/XqV7Lp/g,
                replacement: "https://wiki.php.net/rfc/mysql_deprecation",
                reason: App.consts.reasons.sqlWarnings
            },
            redbox: {
                expr: /http:\/\/j.mp\/Te9zIL/g,
                replacement: "https://www.php.net/manual/en/function.mysql-connect.php",
                reason: App.consts.reasons.sqlWarnings
            },
            pdowiki: {
                expr: /http:\/\/j.mp\/T9hLWi/g,
                replacement: "https://en.wikipedia.org/wiki/Prepared_statement",
                reason: App.consts.reasons.sqlWarnings
            },
            decisions: {
                expr: /http:\/\/j.mp\/QEx8IB/g,
                replacement: function(input) {
                    return "https://php.net/manual/en/mysqlinfo.api.choosing.php";
                },
                reason: App.consts.reasons.sqlWarnings
            },
            tutorials: {
        ...
        App.pipeMods.fixLinks = function(data) {
            if(!data.body) return false;
